...
<body class="flex items-center justify-center min-h-screen bg-white">
  <div class="w-full sm:max-w-xl px-6">
    ...
    <div class="mt-10">
      <form action="{{route('admins.index')}}" class="grid grid-flow-row auto-rows-min gap-3 space-y-4 border bg-white rounded-2xl border-gray-200 shadow-xl p-6">
        ...
        <div>
          ...
          <div class="flex-1 relative border border-gray-200 rounded-md">
            <select id="role" class="select select-bordered w-full pl-10 pt-3 pb-3">
