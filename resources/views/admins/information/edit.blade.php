...
<div class="max-w-md bg-white mb-6">
    ...
    <form action="{{ route('thongTinCaNhan.update') }}" method="POST" enctype="multipart/form-data" class="space-y-3">
        ...
        <div>
            ...
            <input type="text" name="hoTen" id="hoTen" value="{{ Auth::user()->nhanVien->hoTen }}" required
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-400">
        </div>
        ...
        <div>
            ...
            <input type="date" name="ngaySinh" id="ngaySinh" value="{{ \Carbon\Carbon::parse(Auth::user()->nhanVien->getRawOriginal('ngaySinh'))->format('Y-m-d') }}" required
        ...
        <div>
            ...
            <input type="text" name="soDienThoai" id="soDienThoai" value="{{ Auth::user()->nhanVien->soDienThoai }}"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-400">
        </div>
        ...
        <div class="flex space-x-3 pt-4">
            <a href="{{ route('thongTinCaNhan.index') }}" class="bg-gray-400 text-white px-4 py-2 rounded-md hover:bg-gray-500 transition text-[18px]">Quay lại</a>
