...
<div class="max-w-md bg-white p-4 rounded-md shadow-md">
    ...
    <form action="{{ route('bienLai.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input 
                type="date" name="ngayThu" id="ngayThu" required class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-400" >
        </div>
