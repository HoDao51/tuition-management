...
<body>
  <aside class="w-64 bg-white border-r border-gray-200 p-4">
    <nav class="flex flex-col space-y-2">
      <!-- Trang tổng quan -->
      <a href="#" class="flex items-center space-x-2 bg-[#D9D9D9] rounded-md px-2.5 py-2 text-gray-700 font-semibold">
      ...
      <!-- Quản lý nhân viên -->
      <a href="#" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9]">
