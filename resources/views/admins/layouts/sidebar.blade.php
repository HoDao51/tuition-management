...
<body>
  <aside class="w-64 bg-white border-r border-gray-200 p-4">
    <nav class="flex flex-col space-y-2">
      @php
        function isActive($actionName) {
            return request()->query('action') == $actionName ? 'bg-[#D9D9D9] font-semibold' : 'text-gray-700 hover:bg-[#D9D9D9]';
        }
      @endphp
      <!-- Trang tổng quan -->
      <a href="{{ url('admins?action=trangtongquan') }}" class="flex items-center space-x-2 rounded-md px-2.5 py-2 text-gray-700 {{ isActive('trangtongquan') }}">
      ...
      <!-- Quản lý nhân viên -->
      <a href="{{ url('admins?action=quanlynhanvien') }}" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9] {{ isActive('quanlynhanvien') }}">
      ...
      <!-- Quản lý sinh viên -->
      <a href="{{ url('admins?action=quanlysinhvien') }}" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9] {{ isActive('quanlysinhvien') }}">
      ...
      <!-- Quản lý khoa -->
      <a href="{{ url('admins?action=quanlykhoa') }}" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9] {{ isActive('quanlykhoa') }}">
      ...
      <!-- Quản lý lớp -->
      <a href="{{ url('admins?action=quanlylop') }}" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9] {{ isActive('quanlylop') }}">
      ...
      <!-- Quản lý năm học -->
      <a href="{{ url('admins?action=quanlynamhoc') }}" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9] {{ isActive('quanlynamhoc') }}">
      ...
      <!-- Quản lý học kỳ -->
      <a href="{{ url('admins?action=quanlyhocky') }}" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9] {{ isActive('quanlyhocky') }}">
      ...
      <!-- Quản lý học phí -->
      <a href="{{ url('admins?action=quanlyhocphi') }}" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9] {{ isActive('quanlyhocphi') }}">
      ...
      <!-- Quản lý biên lai -->
      <a href="{{ url('admins?action=quanlybienlai') }}" class="flex items-center space-x-2 text-gray-700 px-3 py-2 rounded-md hover:bg-[#D9D9D9] {{ isActive('quanlybienlai') }}">
