...
@section('content')
  <div class="mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <!-- Tổng nhân viên -->
            <div class="bg-blue-500 text-white p-6 rounded-xl shadow-xl shadow-black/30 flex justify-center items-center w-4/5 h-[200px] mx-auto">
            ...
            <!-- Tổng sinh viên -->
            <div class="bg-green-500 text-white p-6 rounded-xl shadow-xl shadow-black/30 flex justify-center items-center w-4/5 mx-auto">
                <!-- Nội dung chính: icon + số + chữ -->
                <div class="flex items-center space-x-6">
                    <!-- Icon bên trái -->
                    <div class="flex-shrink-0">
            ...
            <div class="bg-[#F59E0B] text-white p-6 rounded-xl shadow-xl shadow-black/30 flex justify-center items-center w-4/5 h-[200px] mx-auto">
                <!-- Nội dung chính: icon + số + chữ -->
                <div class="flex items-center space-x-6">
                    <!-- Icon bên trái -->
                    <div class="flex-shrink-0">
            ...
            <!-- Sinh viên chưa đóng -->
            <div class="bg-[#EA3438] text-white p-6 rounded-xl shadow-xl shadow-black/30 flex justify-center items-center w-4/5 mx-auto">
                <!-- Nội dung chính: icon + số + chữ -->
                <div class="flex items-center space-x-6">
                    <!-- Icon bên trái -->
                    <div class="flex-shrink-0">
