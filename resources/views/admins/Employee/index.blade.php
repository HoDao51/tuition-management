      ...
      <table class="min-w-full border border-gray-200 text-sm text-left">
        ...
        <tbody>
          <tr class="hover:bg-gray-50">
            ...
            <td class="px-2 py-2 border text-[17px]">
              @if(($item->tinhTrang) == 0)
              <div class="text-green-500 border border-green-400 rounded-full font-medium text-center">
                  Đang hoạt động
              </div>
              @else
              <div class="text-red-500 border border-red-400 rounded-full font-medium text-center">
                  Ngưng hoạt động
              </div>
              @endif
            </td>
