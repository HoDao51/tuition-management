    ...
    <div class="">
      <div class="flex items-center space-x-2 mb-4">
        ...
        <div class="relative w-1/3">
            ...
            class="bg-[#F2F2F2] pl-10 pr-3 py-2 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-gray-300"
            >
        </div>
        <!-- Nút tìm kiếm -->
    ...
    <div class="overflow-x-auto">
      <table class="min-w-full border border-gray-200 text-sm text-left">
        <thead class="bg-[#D9D9D9] text-gray-700 uppercase">
          <tr>
            <th class="px-4 py-2 border w-[150px] text-center">Mã khoa</th>
        ...
        <tbody>
          <tr class="hover:bg-gray-50">
            ...
            <td class="px-4 py-2 border text-center">
                ...
                {{-- Nút xóa --}}
                <form action="{{ route('khoa.destroy', $item->id) }}" method="POST" class="inline-block">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
